...
class Base(object):
    ...
    def sendKeys(self, locator, text,is_clear=False):
        ...
        print('Base - > 开始对%s元素 [输入文本]：%s'%(locator,text))

    def click(self, locator):
        '''点击元素'''
        element = self.findElement(locator)
        element.click()
        print('Base - > 开始对%s元素  [点击]'%str(locator))
    ...
    def swith_first_handle(self):
        try:
            ...
            print("Base - >  切换至第一个handles异常! Reason：%s" % e)
    ...
    def switch_frame(self, locator):
        ...
        try:
            ...
            print('Base - > 成切换到iframe框架中')
            return result
        except Exception as e:
            print("Base - > 切换iframe异常! Reason:%s" % e)
            self.get_Screenshots()
            raise
    ...
    def switch_to_defaultFrame(self):
        ...
        print('Base - > 跳出所有frame,回到主界面')
    def switch_to_parentFrame(self):
        '''返回上一级iframe'''
        self.driver.switch_to.parent_frame()
        print('Base - >  返回上一级iframe')
    ...
    def acceptAlert(self):
        ...
        # print('Base - >点击系统弹框的确定按钮')
        # print('Base - > Click the ok button in the system popup box')
    ...
    def dismissAlert(self):
        ...
        print('点击系统弹框的取消按钮')
        # print('Base - > Click the cancel button in the system popup box')

    def getAlertText(self):
        '''获取弹出框文本'''
        text = self.driver.switch_to.alert.text
        print('Base - >  开始获取系统弹出框文本：%s'%text)
        return text
